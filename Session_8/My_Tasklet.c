/***************************************************************************************************************
@fileName : My_Tasklet.c
@author   : Kishan Mandaliya 
@teamLead : Rajesh Dommaraju 
@details  : It is a module for Interrupt Handling Bottom Half(Tasklet).
...
#define DRIVER_MODULE_DESC                      "TaskLet"
#define DRIVER_MODULE_VERSION                   "V1.9"
#define SUCCESS  0
#define FAILURE -1
#define STATIC_METHOD 0
//#define STATIC_WORKQUEUE 
//#define STATIC_TASKLET
#define IRQ_NO 11
...
/****************************************TaskLet***************************************************************/void tasklet_fn(unsigned long);

// Init the Tasklet by static Method
#ifdef STATIC_TASKLET
...
void tasklet_fn(unsigned long arg)
{
	...
	printk(KERN_INFO "Yes!!!..Executing Tasklet Function : Arg = %ld \n",arg);

}

/****************************************WorkQueue*************************************************************/

#ifdef STATIC_WORKQUEUE
...
static int My_Driver_init(void) 
{
   ...
   if((dev_class = class_create(THIS_MODULE,"My_class")) == NULL){
    ...
    #ifndef STATIC_WORKQUEUE
    /*Creating work by Dynamic Method */
    INIT_WORK(&workqueue,workqueue_fn);
    #endif

    #ifndef STATIC_TASKLET
    /*Creating tasklet by Dynamic Method */
    tasklet = kmalloc(sizeof(struct tasklet_struct), GFP_KERNEL);
    if(tasklet == NULL)
    {
	printk(KERN_INFO "My_device : Can't allocate Memory \n");
	goto irq;
    }
